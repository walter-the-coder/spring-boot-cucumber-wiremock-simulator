...
class InformationFlowStepDefs(val objectMapper: ObjectMapper) : En {
    ...
    init {
        ...
        Then("we should receive a response informing us that the information processed with status {string}") { expectedStatus: String ->
